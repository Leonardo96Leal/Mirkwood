...
public class Map extends Panel {
            ...
            protected ComponentRenderer<EmptySpace> createDefaultRenderer() {
                return new ComponentRenderer<EmptySpace>() {
                    ...
                    public void drawComponent(TextGUIGraphics graphics, EmptySpace component) {
                        ...
                        final int pon = mRand.nextInt(LINES);
                        for (int i = 0; i < waterpos.length; i++) {
                            ...
                            while(cont==0){
                                ...
                                graphics.putString(waterpos[pon], pon, String.valueOf(SymbolsMirk.HERO));
                                graphics.setForegroundColor(new TextColor.RGB(30, 150, 200));
                                cont++;
                            }
                        }
                        graphics.putString(15, 5, String.valueOf(SymbolsMirk.WATER[2]));
 ...
 /*
    ...
    public void generateWater() {
        ...
        int col1 = mRand.nextInt(LINES);
        for (int i = 0; i < COLUMNS; i++) {
            waterpos1[i] = col1 + (mRand.nextInt(2) - 1);
        }
    }
